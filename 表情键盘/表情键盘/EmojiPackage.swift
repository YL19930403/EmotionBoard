...
//        var packages = [EmojiPackage]()
    ...
    func infoPath(fileName: String) -> String {
        return (EmojiPackage.emoticonPath().stringByAppendingPathComponent(id!) as NSString).stringByAppendingPathComponent(fileName)
    }
...
class Emoticon: NSObject {
    ...
    var png : String?
        {
        didSet{
            imagePath = (EmojiPackage.emoticonPath().stringByAppendingPathComponent(id!) as NSString).stringByAppendingPathComponent(png!)
        }
    }
